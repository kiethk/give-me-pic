  ...
  return (
    <>
      <div className="text-center lg:text-left">
        <h2 className="text-3xl font-bold tracking-tight text-[#111c2d]">Welcome back</h2>
        <p className="mt-2 text-sm text-[#727687]">
          Enter your details to access your archive.
        </p>
      </div>
      ...
      <form className="mt-8 space-y-5 rounded-2xl border border-[#e2e8f0] bg-white p-8 shadow-sm" onSubmit={handleSubmit}>
        ...
        <div>
          <div className="flex items-center justify-between">
            ...
            <a href="#" className="text-xs font-medium text-[#0050cb] hover:underline">Forgot password?</a>
          </div>
          <input
            required
            minLength={8}
      ...
      <p className="mt-8 text-center text-sm text-[#727687]">
        ...
        <Link href="/register" className="font-medium text-[#0050cb] hover:underline">
          Create one
        </Link>
      </p>
    </>
